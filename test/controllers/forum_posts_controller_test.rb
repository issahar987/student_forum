...
class ForumPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum_post" do
    assert_difference("ForumPost.count") do
      post forum_posts_url, params: { forum_post: { ID_Role: @forum_post.ID_Role, ID_User: @forum_post.ID_User, content: @forum_post.content, description: @forum_post.description, isHandBook: @forum_post.isHandBook, title: @forum_post.title } }
    end
  ...
  test "should update forum_post" do
    patch forum_post_url(@forum_post), params: { forum_post: { ID_Role: @forum_post.ID_Role, ID_User: @forum_post.ID_User, content: @forum_post.content, description: @forum_post.description, isHandBook: @forum_post.isHandBook, title: @forum_post.title } }
